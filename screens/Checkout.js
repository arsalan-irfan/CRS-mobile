...
import { addProduct, removeProduct, incQuantity, decQuantity, emptyCart } from '../actions/cartActions';
                                ...
                                <View style={{ flex: 1, flexDirection: 'row', margin: 5, padding: 20, paddingTop: 5 }}>
                                    ...
                                    <View style={{ flex: 1, justifyContent: "center", alignItems: "flex-end" }} >
                                        ...
                                        <View style={{ paddingRight: 10 }}>
                                            ...
                                            <Text style={{ fontSize: 20, color: "#000" }}>Rs <Text style={{ fontWeight: "bold" }}>{totalPrice}</Text></Text>
                                            ...
                                            : (
                                                <>
                                                    ...
                                                    <View style={{ marginTop: 10 }}>
                                                        <Button
                                                            style={{ borderRadius: 20, marginBottom: 30, backgroundColor: "#2A83F7", marginTop: 10 }}
                                                            color={"red"}
                                                            title="Empty Cart"
...
export default connect(mapStateToProps, { showSnackbar,addProduct, removeProduct, incQuantity, decQuantity, emptyCart })(Checkout)